...
const ftp_settings = require('./ftp_settings.js');
...
console.log(checkProperties(ftp_settings));

if(checkProperties(ftp_settings) === false) {
  console.log("\x1b[31m","Uzupełnij dane w pliku ftp_settings.js");
  console.log("\x1b[0m");
  process.exit(1);
}
  ...
  let config = {
    ...
    plugins: (() => {
      ...
      const production = [
        ...
        new plugins.ftpupload(ftp_settings),
        new plugins.copy([
          {
